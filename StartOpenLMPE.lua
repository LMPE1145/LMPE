...
game:GetService("StarterGui"):SetCore("SendNotification",{Title="提示";Text="LMPEovo\n请等待1-12秒喵";Icon="rbxassetid://114514";Duration=3;})
...
local UITab14 = win:Tab("『DOORS』",'114514')
...
local lbl1 = about:Label("114514")
RainbowFont(lbl1)
local lbl2 = about:Label("作者:LatchMod")
RainbowFont(lbl2)
local lbl3 = about:Label("感谢支持LMPE脚本")
RainbowFont(lbl3)
...
about:Button("复制服务器名称", function()
    ...
    game:GetService("StarterGui"):SetCore("SendNotification",{Title="LMPE";Icon="rbxassetid://114514";Text="服务器名称已复制喵";Duration=3;})
end)

about:Button("复制脚本学习+制作交流群", function()
    setclipboard("574149379")
    game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "LMPE"; Icon = "rbxassetid://114514"; Text ="群号已复制喵"; Duration = 3; })
end)
...
about:Textbox("自定义范围", "HitBox", "输入", function(Value)
    ...
    if _G.HeadSize then
        ...
        game:GetService("StarterGui"):SetCore("SendNotification",{Title="LMPE";Icon="rbxassetid://114514";Text="范围已设置喵";Duration=3;})
    else
        game:GetService("StarterGui"):SetCore("SendNotification",{Title="LMPE";Icon="rbxassetid://114514";Text="请输入数字喵";Duration=3;})
    end
end)
...
about:Button("关闭范围", function()
    ...
    game:GetService("StarterGui"):SetCore("SendNotification",{Title="LMPE";Icon="rbxassetid://114514";Text="范围关闭了喵";Duration=3;})
end)
...
about:Button("彩虹", function()
    ...
    game:GetService("StarterGui"):SetCore("SendNotification",{Title="LMPE";Icon="rbxassetid://114514";Text="彩虹已启用喵";Duration=3;})
end)
...
about:Button("甩飞一次选中的人", function()
    ...
    if not TargetPlayer or TargetPlayer == Player then
        game:GetService("StarterGui"):SetCore("SendNotification", {Title = "LMPE", Text = "无玩家可甩飞", Duration = 2, Icon = "rbxassetid://114514"})
        return
    end
    ...
    local SkidFling = function(Target)
        ...
        if not (Character and Humanoid and RootPart and TCharacter and THumanoid) then
            return Message("LMPE", "玩家已趋势", 2)
        end
        if THumanoid.Sit then return Message("LMPE", "目标处于坐姿", 2) end
        if not TCharacter:FindFirstChildWhichIsA("BasePart") then return Message("LMPE", "玩家已趋势", 2) end
        ...
        Message("LMPE", "已甩飞选中玩家", 2)
    end

    if TargetPlayer.UserId ~= 1414978355 then
        SkidFling(TargetPlayer)
    else
        Message("LMPE", "该玩家存在甩飞名单", 2)
    end
end)
...
game:GetService("StarterGui"):SetCore("SendNotification", {Title = "LMPE", Text = "目标处于坐姿", Duration = 2, Icon = "rbxassetid://114514"})
isRunning = false
return
end
if not TCharacter:FindFirstChildWhichIsA("BasePart") then
game:GetService("StarterGui"):SetCore("SendNotification", {Title = "LMPE", Text = "玩家已趋势", Duration = 2, Icon = "rbxassetid://114514"})
isRunning = false
return
end
...
about:Button("甩飞所有人", function()
    ...
    if not hasPlayers then
        return Message("LMPE", "无玩家可以甩飞", 2)
    end
    if not Welcome then Message("LMPE", "甩飞增强版", 2) end
...
local about = UITab8:section("『LMPE☆自然灾害』", true)
about:Label("检测到你当前的服务器不是☆自然灾害☆")
about:Label("亲爱的LMPE用户")
about:Label("请到自然灾害执行脚本 会加载对应功能")

local about = UITab9:section("『LMPE☆力量传奇』", true)
about:Label("检测到你当前的服务器不是☆力量传奇☆")
about:Label("亲爱的LMPE用户")
about:Label("请到力量传奇执行脚本 会加载对应功能")

local about = UITab10:section("『LMPE☆极速传奇』", true)
about:Label("检测到你当前的服务器不是☆极速传奇☆")
about:Label("亲爱的LMPE用户")
about:Label("请到极速传奇执行脚本 会加载对应功能")

local about = UITab11:section("『LMPE☆忍者传奇』", true)
about:Label("忍者传奇更新中")

local about = UITab12:section("『LMPE☆战争大亨』", true)
about:Label("检测到你当前的服务器不是☆战争大亨☆")
about:Label("亲爱的LMPE用户")
about:Label("请到战争大亨执行脚本 会加载对应功能")

local about = UITab13:section("『LMPE☆刀球刃』", true)
about:Label("刀球刃更新中")

local about = UITab14:section("『DOORS』",true)

about:Button("LMPE-DOORS", function()
...
local Window = OrionLib:MakeWindow({IntroText = "“门” 脚本 LMPE",Name = "“门” LMPE汉化", HidePremium = false, SaveConfig = true, ConfigFolder = "DoorsSex"})
...
game:GetService("StarterGui"):SetCore("SendNotification",{Title="欢迎使用";Text="StartOpenui加载成功喵";Icon="rbxassetid://114514";Duration=3;})
